import Mathlib.Data.Nat.Fib.Basic
    ...
    -- For n ≥ 100000, (n - n/1000)*100/n ≥ 99
    ...
    have h_ge : (n - n / 1000) * 100 ≥ 99 * n := by
      ...
      calc (n - n / 1000) * 100
          = (n / 1000 * 999 + n % 1000) * 100 := by rw [h1]
    ...
    -- For any ε ≥ 1, from N₀ = 4M, (n-9)*100/n ≥ 100-ε
    ...
    have h_ge : (n - 9) * 100 ≥ (100 - ε) * n := by
      have hε_le : ε ≤ 100 := by omega
      have hn9   : 9 ≤ n    := by omega
      have hεn   : ε * n ≥ 1 * 4000000 := Nat.mul_le_mul hε hn
      zify [hn9, hε_le] at *
      nlinarith
    exact (Nat.le_div_iff_mul_le hpos).mpr h_ge
    ...
    theorem certified_full_chain :
      ...
      Nat.Coprime 610 987 :=
    ⟨by rfl, by rfl, by native_decide,
     by native_decide, by native_decide, by native_decide, by rfl, by native_decide⟩
