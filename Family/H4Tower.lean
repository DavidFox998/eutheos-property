...
theorem tower_inflation_56_90  : (90 : ℝ)/56  > 1.6 ∧ (90 : ℝ)/56  < 1.7 := by constructor <;> norm_num
theorem tower_inflation_90_146 : (146 : ℝ)/90 > 1.6 ∧ (146 : ℝ)/90 < 1.7 := by constructor <;> norm_num
...
theorem density_tower_56  : (9 : ℝ) / 4000000 ^ 56  < 1e-300 := by norm_num
-- 9 / 4000000^90 < 10^-300  (actual ≈ 10^-553)
theorem density_tower_90  : (9 : ℝ) / 4000000 ^ 90  < 1e-300 := by norm_num
-- 9 / 4000000^146 < 10^-300 (actual ≈ 10^-898)
theorem density_tower_146 : (9 : ℝ) / 4000000 ^ 146 < 1e-300 := by norm_num
