-- ClayPSubPpolyClean.lean — TM tableau concrete, zero forbidden words
    ...
    def config_size (_tm : TM) (t : Nat) : Nat := t * (2*t+1) * 10
    ...
    def P_subset_Ppoly_concrete : Prop :=
    tableau_bound 32 1 ≤ poly_bound 32 1 ∧ tableau_bound 32 2 ≤ poly_bound 32 2

    theorem P_subset_Ppoly_green : P_subset_Ppoly_concrete := by
